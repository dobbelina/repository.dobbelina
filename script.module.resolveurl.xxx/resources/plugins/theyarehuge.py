...
class TheyAreHugeResolver(ResolveUrl):
    name = 'TheyAreHuge'
    domains = ['theyarehuge.com']
    pattern = r'(?://|\.)(theyarehuge\.com)/(?:v|embed)/([^\.]+)'
    ...
    def get_url(self, host, media_id):
        return self._default_get_url(host, media_id, template='https://www.{host}/v/{media_id}.big-boobs')
