...
def INDEXH():
    ...
    utils.addDir('[COLOR hotpink]CartoonPornVideos[/COLOR]','https://www.cartoonpornvideos.com/videos/straight/all-recent-1.html',890,os.path.join(imgDir, 'cartoonpornvideos.png'),'')
