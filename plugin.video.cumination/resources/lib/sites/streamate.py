...
def Playvid(url, name):
    ...
    response = utils.getHtml("https://streamate.com/ajax/config/?name=" + url + "&sakey=&sk=streamate.com&userid=0&version=2.2.0&ajax=1")
    ...
    while quitting == 0:
        ...
        if message == '40/live':
            ...
            videourl = ''
            response = utils.getHtml("https://manifest-server.naiadsystems.com/live/s:{0}.json?last=load&format=mp4-hls".format(url))
